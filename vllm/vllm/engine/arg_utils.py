...
class EngineArgs:
    ...
    chunk_size: Optional[int] = None # for chunked-prefill ver 1
    ...
    # preemption related configs
    preemption_mode: Optional[str] = None
    # Mixed batching approach
    ...
    def add_cli_args(
        ...
        parser.add_argument(
            ...
            type=int,
            default=None,
            help='If set, the prefill requests can be chunked into fixed size chunks') 
        ...
        parser.add_argument('--preemption-mode',
            ...
            help='Preemption mode for the engine when processing KV Cache overflow')

        parser.add_argument('--enable-mixed-batch',
            action='store_true',
            help='Enable mixed batching approach for the engine') 
