...
class BlockSpaceManagerV1(BlockSpaceManager):
    ...
    def can_allocate(self, seq_group: SequenceGroup) -> AllocStatus:
        ...
        if num_free_gpu_blocks - num_required_blocks >= self.watermark_blocks:
            ...
            logger.warning(f"BlockSpaceManagerV1: free blocks will less than the threshold if allocated, current_free_gpu_blocks={num_free_gpu_blocks}, required_blocks={num_required_blocks}, threshold={self.watermark_blocks}")
    ...
    def can_append_slots(self,
        ...
        if num_seqs > num_free_gpu_blocks: 
            logger.warning(f"BlockSpaceManagerV1: number of sequences > free gpu blocks, num_seqs={num_seqs}, free_gpu_blocks={num_free_gpu_blocks}")
