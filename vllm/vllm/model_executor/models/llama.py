...
class LlamaDecoderLayer(nn.Module):
    ...
    def forward(
        ...
        # print(f"Decodelayer: input_layernorm={(start_1-start)* 1e3:.4f} self_attn={(start_2-start_1) * 1e3:.4f} post_attention_layernorm={(start_3-start_2) * 1e3:.4f} mlp={(start_4-start_3) * 1e3:.4f}", flush=True)
...
class LlamaModel(nn.Module):
    ...
    def __init__(
        ...
        # ])
        self.layers = nn.ModuleList([
            LlamaDecoderLayer(config, quant_config, id)
    ...
    def forward(
        ...
        # logger.info(f"transformer layers takes {dur:.4f} ms") 
