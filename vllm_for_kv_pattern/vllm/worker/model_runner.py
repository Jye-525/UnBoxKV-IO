...
class ModelRunner:
    ...
    def prepare_input_tensors(
        ...
        if self.is_driver_worker:
            ...
            # print(f"Diver_worker: prepare_prompt_inputs: {len(prefill_reqs)} prefill requests, {len(decode_reqs)} decode requests")
            ...
            # print(f"Driver_worker: sampling_metadata: {sampling_metadata}")
            ...
            if batch_type == BatchType.PREFILL or batch_type == BatchType.MIXED:
                ...
                decode_attn_metadata = self.attn_backend.make_metadata(
                    **metadata_dict)
            # print(f"In non-drive Worker: prepare_prompt_inputs: {len(seq_group_metadata_list)} requests")
    ...
    def execute_model(
        ...
        # print(f"hidden_states.shape={hidden_states.shape}, sampling_metadata = {sampling_metadata}")
        ...
        # torch.cuda.nvtx.range_pop()
        # logger.info(f"ModelRunner inputs to model.sample(): logits.shape={logits.shape}")
    ...
    def close_writer(self):
        ...
        print(f"ModelRunner: close_writer()", flush=True)
        del self.model
