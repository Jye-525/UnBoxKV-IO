...
class BlockSpaceManagerV1(BlockSpaceManager):
    ...
    def can_allocate(self, seq_group: SequenceGroup) -> AllocStatus:
        ...
        if num_free_gpu_blocks - num_required_blocks >= self.watermark_blocks:
            ...
            print(f"BlockSpaceManagerV1: num_free_gpu_blocks={num_free_gpu_blocks}, num_required_blocks={num_required_blocks}, {self.watermark_blocks}", flush=True)
    ...
    def can_append_slots(self,
        ...
        if num_seqs > num_free_gpu_blocks: 
            print(f"BlockSpaceManagerV1: num_free_gpu_blocks={num_free_gpu_blocks}, num_seqs={num_seqs}", flush=True)
